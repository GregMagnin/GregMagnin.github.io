...
`,after_render:async()=>{let s=document.getElementById("category"),i=document.getElementById("difficulty"),o=document.getElementById("numbers-of-questions"),r=await a(()=>import("./scaleDownFromTop.1a8f9a78.js"),[]);s.addEventListener("click",async()=>{await r.default("categories")}),i.addEventListener("click",async()=>{await r.default("levels")}),o.addEventListener("click",async()=>{await r.default("nbQuestions")});let t=document.getElementById("start-quiz"),e=await a(()=>import("./rotateFallLeft.6c4e96c0.js"),[]);t.addEventListener("click",async n=>{await e.default()})}},R=Object.freeze(Object.defineProperty({__proto__:null,default:y},Symbol.toStringTag,{value:"Module"})),g={render:async()=>`
...
`,after_render:async()=>{await(await a(()=>import("./questions.cf46bc7c.js"),[])).default()}},I=Object.freeze(Object.defineProperty({__proto__:null,default:E},Symbol.toStringTag,{value:"Module"})),h={render:async()=>`
        <section class="result" id="js-result-section">
          ...
          <div class="result__img">
            <img src="/quizzos/assets/quizzosResult.svg" alt="quizzos mascot representing a brain">
          </div>
        </section>
        `,after_render:async()=>{let s=await a(()=>import("./jaw.bdb0e742.js"),[]),i=document.getElementById("js-result-section");i.innerHTML+=s.default,await a(()=>import("./progressBar.cdaf516b.js"),[]),await a(()=>import("./closingPageAnimation.a306c7f0.js"),["assets/closingPageAnimation.a306c7f0.js","assets/index.c6ddc126.js"])}},z=Object.freeze(Object.defineProperty({__proto__:null,default:h},Symbol.toStringTag,{value:"Module"})),w={render:async()=>`
  ...
  <span data-repetition=""></span>
   ...
   `,after_render:async()=>{await a(()=>import("./timer.40b6cfcf.js"),[]),await a(()=>import("./start-quiz.2d8d7c36.js"),[])}},k=Object.freeze(Object.defineProperty({__proto__:null,default:w},Symbol.toStringTag,{value:"Module"})),m={"/":v,home:v,lobby:y,levels:g,nbquestion:f,categories:b,questions:E,result:h,timer:w},T=document.getElementById("app"),L=async()=>{let s=location.hash.split("#")[1]||"/";T.innerHTML=await m[s].render(),await m[s].after_render()};window.addEventListener("hashchange",async()=>{await L()});window.addEventListener("load",async()=>{await L()});export{D as C,S as H,R as L,A as N,I as Q,z as R,k as T,a as _,P as a};
